...
# note: may get rid of this; NOT necessary.
...
# note: slightly changed but also changed back -- hope it still works!
find_effective_range = function(p, m, x_vector_matrix, y_vector_matrix,
                                quantile_val = c(0.005,0.995)){
  # m: num of sub-intervals
  # note: assuming quantile_val is consistent for each y-val
...
## HAS BEEN MODIFIED, USE OTHER VER
# changed below.
